#!/usr/bin/env python
# http://comments.gmane.org/gmane.comp.python.fipy/2950  BUG
## 
 # ###################################################################
...
...     try:
...         viewer = Viewer(vars=phi, datamin=-1, datamax=1.) #http://comments.gmane.org/gmane.comp.python.fipy/2950   http://matforge.org/fipy/ticket/539
...         viewer.plotMesh()
